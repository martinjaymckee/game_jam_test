...
// configuration step. It creates a namespace called `game_jam_test`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        game_jam_test::cmake::project_name,
        game_jam_test::cmake::project_version));// version string, acquired
